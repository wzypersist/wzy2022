...
import com.wzy.mySpring.xml.beans.factory.*;
import com.wzy.mySpring.xml.beans.factory.config.*;
...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory implements AutowireCapableBeanFactory {
    ...
    protected Object getEarlyBeanReference(String beanName, BeanDefinition beanDefinition, Object bean) {
        Object expoesdObject = bean;
        for (BeanPostProcessor beanPostProcessor : getBeanPostProcessors()) {
            if(beanPostProcessor instanceof InstantiationAwareBeanPostProcessor){
                ((InstantiationAwareBeanPostProcessor) beanPostProcessor).getEarlyBeanReference(expoesdObject,beanName);
                if(null == expoesdObject)return expoesdObject;
            }
        }
        return expoesdObject;
    }
